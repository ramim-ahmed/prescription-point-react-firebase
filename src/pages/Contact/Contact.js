        ...
        <div>
            <div style={{backgroundImage:`url(${Banner})`}}>
                <div style={{height:'250px'}} className='flex justify-center items-center'>
                    <h1 className="text-5xl text-green-600 font-semibold">Contact</h1>
                </div>
            </div>
         ...
         <form className="w-full max-w-lg">
            ...
            <div className="md:flex md:items-center">
                ...
                <button className="shadow bg-teal-400 hover:bg-teal-400 focus:shadow-outline focus:outline-none text-black font-bold py-2 px-4 rounded" type="button">
                    Send
                </button>
                </div>
